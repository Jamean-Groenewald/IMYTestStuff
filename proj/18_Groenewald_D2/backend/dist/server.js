...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // //u23524121 Jamean Groenewald
var _require = require('mongodb'),
  MongoClient = _require.MongoClient;
var app = (0, _express["default"])();
var port = process.env.PORT || 3000;
var url = "mongodb+srv://jameangroenewald:bjO3XO9MqQnLVHkc@imy220.0n3k2.mongodb.net/?retryWrites=true&w=majority&appName=IMY220";
var publicPath = _path["default"].resolve('frontend', 'public'); // Resolve path from the project root

app.use(_express["default"]["static"](publicPath)); //serve static files from frontend.

//middleware to pass JSON + URL-encoded data stuff.
app.use(_express["default"].json());
app.use('/api', _api["default"]);
app.get('*', function (req, res) {
  //server frontend for any other route.
...
function _main() {
  _main = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var database, userCollection, playlistCollection, songsCollection;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          // Set Database
          database = client.db("IMY220Project");
          userCollection = database.collection("Users");
          playlistCollection = database.collection("Playlists");
          songsCollection = database.collection("Songs"); // app.locals.db = //so that you expose colls to be used in routes.
          // {
